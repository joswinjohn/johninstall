...
hidden if the `johninstall_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `johninstall_DEVELOPER_MODE` to the configure
...
Runs the executable target `johninstall_exe`.
